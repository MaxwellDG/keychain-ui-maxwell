...
//SVGs
import ChevronRight from 'src/assets/svgs/Icons/chevron-right';
import Star from 'src/assets/svgs/Icons/star';
import Numeric1Box from 'src/assets/svgs/Icons/numeric-1-box';
import Numeric2Box from 'src/assets/svgs/Icons/numeric-2-box';
import Numeric4Box from 'src/assets/svgs/Icons/numeric-4-box';
import Numeric5Box from 'src/assets/svgs/Icons/numeric-5-box';
